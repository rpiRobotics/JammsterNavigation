...
class JammsterModel:
	...
	self.lastTime=timeNow
        ...
        distanceRight = (self.rightV * deltaTime) / 6.283 * self.wheelCircumfrence
        distanceLeft = (self.leftV * deltaTime) / 6.283 * self.wheelCircumfrence
...
def wiimote1Callback(data):
    ...
    if abs(data.angular_velocity.x) > .05:
