...
@author: cunnia3
@description: Go to goal but stop if near obstacle, will 
make more complicated behavior later
"""
...
class GoToGoal:
    ...
    def _scanCallback(self, data):
        ...
        for dist in data.ranges:
            if dist > data.range_min and dist < data.range_max and dist < self.obstacle_stop_dist:
                stop = True
                
        self.obstacle_stop = stop
        print stop
